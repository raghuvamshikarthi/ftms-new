...
object UiUtils {
    ...
    val LOG_TAG = UiUtils::class.java.name


    @RequiresApi(api = Build.VERSION_CODES.LOLLIPOP)
    fun showCustomToastMessage(message: String, context: Context, backgroundColorType: Int) {
        showCustomToastMessageLong(message, context, backgroundColorType, Toast.LENGTH_SHORT)
    }

    fun showCustomToastMessageLong(message: String, context: Context?, backgroundColorType: Int, length: Int) {
        ApplicationThread.uiPost(LOG_TAG, "show custom toast", Runnable {
            if (null == context)
                return@Runnable
    ...
    fun decodeFile(mCurrentPhotoPath: String, finalFile: File) {
